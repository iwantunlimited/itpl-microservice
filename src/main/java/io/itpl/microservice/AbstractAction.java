...
import io.itpl.microservice.kafka.KafkaProducerService;
...
import static io.itpl.microservice.kafka.TopicConfiguration.BROADCAST_TOPIC;
...
public abstract class AbstractAction extends MongoExecutorService implements Action {
    ...
    public void execute(ActionRequest req, JsonNode request, JsonNode response) {
        ...
        kafkaProducerService.sendBroadCastMessageBodyToKafka(BROADCAST_TOPIC, null, message);
