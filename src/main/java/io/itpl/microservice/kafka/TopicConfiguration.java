...
public class TopicConfiguration {
  ...
  @Autowired KafkaURLConfiguration kafkaURLConfiguration;
  ...
  public NewTopic messageDelivery() throws ExecutionException, InterruptedException {
    ...
    return TopicBuilder.name(MESSAGE_DELIVERY_TOPIC)
        .partitions(10)
        .config(TopicConfig.RETENTION_MS_CONFIG, "3600000") // minutes * 60,000
        .config(TopicConfig.CLEANUP_POLICY_CONFIG, TopicConfig.CLEANUP_POLICY_DELETE)
        .config(TopicConfig.SEGMENT_MS_CONFIG, "3600000") // minutes * 60,000
        .build();
  }
